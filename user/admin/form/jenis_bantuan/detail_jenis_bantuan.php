...
$q_kriteria = mysqli_query($conn, "SELECT * from kriteria where id_jenis_bantuan='$id' order by kode_kriteria asc");
...
<?php
  ...
  where p.id_penduduk not in (SELECT id_penduduk from alternatif) ";
