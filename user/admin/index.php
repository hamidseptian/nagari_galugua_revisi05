    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="header">Master Data</li>
        <li><a href="?a=struktur"><i class="fa fa-book"></i> <span  style="color:aqua">Struktur Organisasi</span></a></li>
        ...
        <li><a href="?a=perangkat_nagari"><i class="fa fa-book"></i> <span style="color:aqua">Data Perangkat Nagari</span></a></li>
            <li><a href="?a=jenis_bantuan"><i class="fa fa-book"></i> <span style="color:aqua">Data Bantuan</span></a></li>
       ...
       <!-- <li class="header">SPK</li> -->
        ...
        elseif ($level=='Penduduk') {  ?> 
            <li><a href="?a=edit_penduduk&id=<?php echo $iduser ?>"><i class="fa fa-circle-o"></i><span style="color:aqua">Edit Data Penduduk</span></a></li>
            <li><a href="?a=jenis_bantuan"><i class="fa fa-book"></i> <span style="color:aqua">Data  Bantuan</span></a></li>
